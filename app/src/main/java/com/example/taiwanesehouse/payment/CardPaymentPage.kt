...
fun CardPaymentPage(
    ...
    Scaffold(
        topBar = {
            TopAppBar(
                title = { Text("Card Payment", color = Color.Black) },
                    ...
                    scope.launch {
                        try {
                            ...
                            if (createResult.isSuccess) {
                                ...
                                val details = mapOf(
                                    "cardNumber" to viewModel.cardDetails.value.cardNumber,
                                    "expiryDate" to viewModel.cardDetails.value.expiryDate,
                                    "cvv" to viewModel.cardDetails.value.cvv
                                )
